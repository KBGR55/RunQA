        ...
        <div>
            ...
            <div className="container-fluid custom-container-login d-flex justify-content-center align-items-center vh-100">
                <div className="register-container">
                    <div className="login-right p-8 d-flex flex-column justify-content-center">
                        <h2 className="text-center mb-6" style={{ fontWeight: 'bold', color: '#424874' }}>Registro de Usuarios</h2>
